...
.controller("carctrl",function($scope, $http)
{
   ...
   $http.get("https://2147229mca.github.io/spajson/demo1.json")
...
.controller("ucarctrl",function($scope,$http)
{
    $http.get("https://2147229mca.github.io/ultracjson/demo2.json")
    .success(function(response)
    {
      console.log("got the response");
        $scope.data=response;
